        ...
        <div class="col-md-10">
          <div class="container" >
              ...
              <div class="comment">
                ...
                <p class="btn-info text-left" @click="comment()"><a href="#" class="btn btn-default btn-sm"><i class="fa fa-reply"></i> reply</a></p>

                <div class="" v-if="status_comment == true">
                  <div class="col">
